...
class App extends Component {
  ...
  render() {
    if(this.state.names !== undefined){
      var listArchives = this.state.names.map(function(index){
